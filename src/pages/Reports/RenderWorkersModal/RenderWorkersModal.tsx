...
import styles from './RenderWorkersModal.module.scss';

interface IRenderWorkersModal {
  isOpen: boolean;
...
export const RenderWorkersModal: FC<IRenderWorkersModal> = ({
  isOpen,
  onOpenChange,
}) => {
  const date = new Date();
      ...
      <DialogSurface>
        <DialogBody>
          ...
          <DialogActions fluid>
            <Button
              appearance="primary"
              onClick={() => getTripsReport(reportRequest)}
            >
              Сформировать
            </Button>
          </DialogActions>
