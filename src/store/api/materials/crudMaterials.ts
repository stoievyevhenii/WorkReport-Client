...
export async function editMaterial(material: MaterialRequest): Promise<Material[]> {
...
export async function postMaterials(name: string, description: string, count: number, unit: number): Promise<ApiResponse> {
